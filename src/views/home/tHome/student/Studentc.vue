    ...
    <div>
        ...
        <el-card>
            <el-row :gutter="20">
                ...
                <el-col :span="6">
                    <el-button type="success" @click="query(stuId)"  >搜索</el-button>
...
<script>
    ...
    export default {
        ...
        methods:{
            getStudentPage(){
                this.$axios.get('/api/student/findClassStudentPage?pageSize='+this.pageSize+"&classId="+this.classId).then((res)=>
                {
            ...
            handleSizeChange(val) {
                this.$axios.get('/api/student/findClassStudentPage?pageSize='+val+"&classId="+this.classId).then((res)=>{
                    this.tableData=res.data.data.content
                })
            ...
            handleCurrentChange(e) {
                const pageNum=e
                this.$axios.get('/api/student/findClassStudentPage?pageSize='+this.pageSize+"&pageNum="+pageNum+"&classId="+this.classId).then((res)=>{
                    this.tableData=res.data.data.content
                    // console.log(res);
                })
                console.log(`当前页: ${e}`);
            ...
            query(){
                this.$axios.get('/api/student/findByUser/'+this.stuId).then((res)=>{

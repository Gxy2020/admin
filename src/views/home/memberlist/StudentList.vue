<template>
    <div>
        ...
        <el-card>
            <el-row :gutter="20">
                <el-col :span="6">
                    <el-select v-model="departmentId" placeholder="请选择院系" @change="getclassList(departmentId)" >
                        <el-option
...
<script>
    ...
    export default {
        ...
        methods:{
            getStudentPage(){
                this.$axios.get('/api/student/findStudentPage?pageSize='+this.pageSize+"&str=id").then((res)=>
                {
            ...
            handleSizeChange(val) {
                this.$axios.get('/api/student/findStudentPage?pageSize='+val+"&str=id").then((res)=>{
                    this.tableData=res.data.data.content
                })
